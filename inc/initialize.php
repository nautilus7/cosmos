 ...
 * Description: Helper function to initialize Cosmos Theme
 *
 * @package Cosmos
 * @since 0.2.3
 */
...
function cosmos_enqueue_styles() {
	...
	wp_enqueue_style('bootstrap-responsive', get_template_directory_uri() . '/css/bootstrap-responsive.css', array(), null, 'all');
...
// Register images sizes and add support for post-thumbnails
