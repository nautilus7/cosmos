...
/*if ( ! class_exists('NHP_Options') ){
	...
	if(!defined('NHP_OPTIONS_URL')){
		define('NHP_OPTIONS_URL', get_template_directory_uri().'/options/');
	}
}
*/

// Load NHP-Theme-Options-Framework
if(!class_exists('NHP_Options')){
// Define dir constants before options.php to fix for windows, delete on production server
if(!defined('NHP_OPTIONS_DIR')){
    define('NHP_OPTIONS_DIR', str_replace('\\', '/', trailingslashit(dirname(__FILE__) )) );
}

if(!defined('NHP_OPTIONS_URL')){
    define('NHP_OPTIONS_URL', site_url(str_replace(str_replace('\\', '/', ABSPATH), '', str_replace('\\', '/', trailingslashit(dirname(__FILE__))))));
}
